...
export default function AboutPage() {
  ...
  const careerStages = [
    {
      ...
      tools: ["Java","Selenium", "Cypress", "Rest Assured", "TestNG", "CI/CD"],
    },
    {
  ...
  return (
    ...
    >
      {/* Add blobs for the radial gradient glow */}
      <div className="blob blob--a"></div>
      <div className="blob blob--b"></div>

      <section className="container" style={{ paddingBlock: "96px" }}>
        <h1
          className="reveal-up text-gradient-anim"
          style={{
            textAlign: "center",
            marginBottom: "64px",
            fontSize: "clamp(2rem, 4vw, 3rem)", // Dynamically adjust size
            background: "linear-gradient(135deg, var(--accent-2), var(--accent))",
            backgroundSize: "200% 200%",
            animation: "gradientShift 8s var(--ease-in-out-quint) infinite",
        ...
        <div className="career-timeline">
          {careerStages.map((stage, index) => (
            <div
              key={stage.title}
              className={`career-stage reveal-up stagger-${(index % 4) + 1}`}
            >
                  ...
                  <div className="career-header">
                    <h2
                      ...
                      style={{
                        ...
                        backgroundSize: "200% 200%",
                        animation:
                          "gradientShift 8s var(--ease-in-out-quint) infinite",
                        WebkitBackgroundClip: "text",
                        WebkitTextFillColor: "transparent",
                      }}
                    >
